      ...
      <div className="space-y-6 border-t border-gray-200 p-6">
        ...
        <div className="flex items-center justify-between rounded-lg border border-gray-200 p-4">
          <div className="flex items-center">
            ...
            />
            <div>
              <div className="text-sm font-medium text-gray-900">Featured Photo</div>
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
          <h4 className="mb-2 text-xs font-semibold text-gray-700">Keyboard Shortcuts</h4>
          <div className="space-y-1 text-xs text-gray-600">
            <div className="flex justify-between">
              <span>Close modal</span>
              <kbd className="rounded bg-gray-200 px-2 py-0.5 font-mono">Esc</kbd>
            </div>
            <div className="flex justify-between">
              <span>Previous/Next photo</span>
              <kbd className="rounded bg-gray-200 px-2 py-0.5 font-mono">← →</kbd>
            </div>
            <div className="flex justify-between">
              <span>Download</span>
