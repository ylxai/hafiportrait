          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#54ACBF] focus:outline-none focus:ring-1 focus:ring-[#54ACBF]"
              >
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
          {photos.map((photo, index) => {
            ...
            return (
              <div
                key={photo.id}
                className={`group relative aspect-square overflow-hidden rounded-lg border bg-gray-100 transition-all cursor-pointer ${
                  isSelected
                    ? 'ring-4 ring-[#54ACBF]'
